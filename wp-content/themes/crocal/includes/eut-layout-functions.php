					...
					<div class="eut-container">
						<div class="eut-bar-wrapper eut-align-center">
							<div class="eut-post-bar-item eut-post-navigation">
								...
								<a class="eut-backlink eut-pullup-icon" href="<?php echo esc_url( $eut_backlink_url ); ?>" aria-label="<?php the_title_attribute( $eut_backlink ); ?>">
									<svg class="eut-backlink-icon" aria-labelledby="eut-bl-title" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="15px" height="15px" viewBox="0 0 15 15"><title id="eut-bl-title"><?php esc_html_e( 'Backlink', 'crocal' ); ?></title><g><rect width="6" height="6"/><rect x="9" width="6" height="6"/><rect x="9" y="9" width="6" height="6"/><rect y="9" width="6" height="6"/></g></svg>
								</a>
								<?php } ?>
			...
			<?php } ?>
				<ul class="<?php echo esc_attr( $crocal_eutf_socials_classes ); ?>">
					<?php if( 'icons' == $display ) { ?>
						...
						<li><a href="<?php echo esc_url( $eut_email_string ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-email" aria-label="E-mail"><i class="fas fa-envelope"></i></a></li>
						<?php } ?>
						<?php if ( !empty( $eut_facebook  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-facebook" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a></li>
						<?php } ?>
						<?php if ( !empty( $eut_twitter  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-twitter" aria-label="Twitter"><i class="fab fa-twitter"></i></a></li>
						<?php } ?>
						<?php if ( !empty( $eut_linkedin  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-linkedin" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a></li>
						<?php } ?>
						<?php if ( !empty( $eut_pinterest  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" data-pin-img="<?php echo esc_url( crocal_eutf_get_thumbnail_url() ); ?>" class="eut-social-share-pinterest" aria-label="Pinterest"><i class="fab fa-pinterest"></i></a></li>
						<?php } ?>
						<?php if ( !empty( $eut_reddit ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-reddit" aria-label="Reddit"><i class="fab fa-reddit"></i></a></li>
						<?php } ?>
						<?php if ( !empty( $eut_tumblr ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-tumblr" aria-label="Tumblr"><i class="fab fa-tumblr"></i></a></li>
						<?php } ?>
						<?php if ( !empty( $eut_likes  ) ) { ?>
						<li><a href="#" class="eut-like-counter-link <?php echo crocal_eutf_likes( $post_id, 'status' ); ?>" data-post-id="<?php echo esc_attr( $post_id ); ?>" aria-label="<?php esc_attr_e( 'Like' , 'crocal' ); ?>"><i class="fas fa-heart"></i><span class="eut-like-counter"><?php echo crocal_eutf_likes( $post_id, 'number' ); ?></span></a></li>
						<?php } ?>
				<?php } else { ?>
						<?php if ( !empty( $eut_email  ) ) { ?>
						...
						<?php } ?>
						<?php if ( !empty( $eut_facebook  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-facebook eut-heading-color eut-text-hover-primary-1">Facebook</a></li>
						<?php } ?>
						<?php if ( !empty( $eut_twitter  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-twitter eut-heading-color eut-text-hover-primary-1">Twitter</a></li>
						<?php } ?>
						<?php if ( !empty( $eut_linkedin  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-linkedin eut-heading-color eut-text-hover-primary-1">LinkedIn</a></li>
						<?php } ?>
						<?php if ( !empty( $eut_pinterest  ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" data-pin-img="<?php echo esc_url( crocal_eutf_get_thumbnail_url() ); ?>" class="eut-social-share-pinterest eut-heading-color eut-text-hover-primary-1">Pinterest</a></li>
						<?php } ?>
						<?php if ( !empty( $eut_reddit ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-reddit eut-heading-color eut-text-hover-primary-1">Reddit</a></li>
						<?php } ?>
						<?php if ( !empty( $eut_tumblr ) ) { ?>
						<li><a href="#" data-share-url="<?php echo esc_url( $eut_permalink ); ?>" title="<?php echo esc_attr( $eut_title ); ?>" class="eut-social-share-tumblr eut-heading-color eut-text-hover-primary-1">Tumblr</a></li>
						<?php } ?>
						<?php if ( !empty( $eut_likes  ) ) { ?>
						<li><a href="#" class="eut-like-counter-link eut-heading-color eut-text-hover-primary-1 <?php echo crocal_eutf_likes( $post_id, 'status' ); ?>" data-post-id="<?php echo esc_attr( $post_id ); ?>" aria-label="<?php esc_attr_e( 'Like' , 'crocal' ); ?>"><i class="fas fa-heart"></i><span class="eut-like-counter"><?php echo crocal_eutf_likes( $post_id, 'number' ); ?></span></a></li>
						<?php } ?>
				<?php } ?>
				</ul>
			</div>
