 ...
 */
if ( ! function_exists( 'crocal_eutf_wp_kses_allowed_html' ) ) {
	function crocal_eutf_wp_kses_allowed_html( $allowedposttags, $context ) {
		if ( is_array( $context ) ){
...
add_filter( 'wp_kses_allowed_html', 'crocal_eutf_wp_kses_allowed_html', 10, 2 );
...
if ( version_compare( get_bloginfo('version'), '5.5', '>=' ) ) {
	add_filter( 'crocal_eutf_the_content', 'wp_filter_content_tags' );
} else {
