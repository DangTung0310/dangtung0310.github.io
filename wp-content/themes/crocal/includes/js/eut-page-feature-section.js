jQuery(document).ready(function($) {
	...
	$('.eut-select-color-extra').trigger('change');
	...
	$(document).on("click","#eut-upload-multi-map-point",function() {
		...
		var dataParams = {
			action:'crocal_eutf_get_map_point',
			map_mode:'new',
			_eutf_nonce: crocal_eutf_feature_section_texts.nonce_map_point
		};
		$.post( crocal_eutf_feature_section_texts.ajaxurl, dataParams, function( mediaHtml ) {
