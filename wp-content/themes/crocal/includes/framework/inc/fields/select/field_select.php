    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'crocal' );
                ...
                echo '<select ' . $multi . ' id="' . $this->field['id'] . '-select" data-placeholder="' . esc_attr( $placeholder ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . $nameBrackets . '" class="redux-select-item ' . $this->field['class'] . $sortable . '"' . $width . ' rows="6">';
                echo '<option></option>';
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'crocal' ) . '</strong>';
            }
        } //function
