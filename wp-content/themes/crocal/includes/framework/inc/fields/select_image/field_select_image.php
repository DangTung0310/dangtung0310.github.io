    ...
    class ReduxFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . esc_attr( $placeholder ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" class="redux-select-item redux-select-images ' . $this->field['class'] . '"' . $width . ' rows="6">';
                echo '<option></option>';
