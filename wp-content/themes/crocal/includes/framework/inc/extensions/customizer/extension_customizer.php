        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->_extension_dir ) ) {
                    ...
                    //REDUX_MOD_TOM
                    $this->_extension_url = get_template_directory_uri() . '/includes/framework/inc/extensions/customizer/';
                }
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'crocal' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'crocal' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'crocal' ),
