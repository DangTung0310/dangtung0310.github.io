        ...
        class ReduxFramework_options_object {
            ...
            public function render() {
                ...
                if ( ! $this->is_field || ( $this->is_field && false == $fullWidth ) ) { ?>
                    ...
                    <table id="<?php echo esc_attr($id); ?>" class="form-table no-border redux-group-table redux-raw-table">
                    <tbody><tr><td>
<?php
                    $bDoClose = true;
                }
?>                
                <fieldset id="<?php echo esc_attr($id); ?>" class="redux-field redux-container-<?php echo esc_attr($this->field['type']) . ' ' . esc_attr($this->field['class']); ?>" data-id="<?php echo esc_attr($this->field['id']); ?>">
                    <h3><?php esc_html_e( 'Options Object', 'crocal' ); ?></h3>
                    <div id="redux-object-browser"></div>
                    <div id="redux-object-json" class="hide"><?php echo json_encode( $this->parent->options, true ); ?></div>
                    <a href="#" id="consolePrintObject" class="button"><?php esc_html_e( 'Show Object in Javascript Console Object', 'crocal' ); ?></a>
                </div>
                </fieldset>
<?php
                if ( true == $bDoClose ) { ?>
