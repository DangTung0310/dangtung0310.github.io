...
?>
		...
		<div id="<?php echo esc_attr( $crocal_eutf_anchor_id ); ?>" class="<?php echo esc_attr( $crocal_eutf_anchor_classes ); ?>">
			<div class="eut-wrapper eut-anchor-wrapper">
				<div class="eut-container">
					<a href="#" class="eut-anchor-btn"><i class="eut-icon-menu" aria-label="hidden"></i><span class="screen-reader-text"><?php esc_html_e( 'Anchor Menu', 'crocal' ); ?></span></a>
					<?php
					wp_nav_menu(
						array(
...
?>
	<li class="eut-topbar-item">
		<nav class="eut-top-bar-menu eut-small-text eut-list-divider" aria-label="<?php esc_attr_e( 'Top Bar', 'crocal' ); ?>">
			<?php
				if( 'left' == $position ) {
	...
	if ( !empty( $options ) && !empty( $social_options ) ) {
		...
		foreach ( $social_options as $key => $value ) {
			if ( isset( $options[$key] ) && 1 == $options[$key] && $value ) {
				if ( 'skype' == $key ) {
					echo '<li><a href="' . esc_url( $value, array( 'skype', 'http', 'https' ) ) . '" class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"></a></li>';
				} else {
					$link_target = crocal_eutf_option('social_options_link_target', '_blank');
					if ( '_blank' == $link_target ) {
						echo '<li><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer" class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"></a></li>';
					} else {
						echo '<li><a href="' . esc_url( $value ) . '" class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"></a></li>';
					}
				}
			}
		}
			...
			if ( !empty( $header_menu_options ) ) {
				foreach ( $header_menu_options as $key => $value ) {
					if( !empty( $value ) && '0' != $value && crocal_eutf_check_header_elements_visibility( $key ) ) {
						if ( 'search' == $key ) {
						?>
							<li class="eut-header-element"><a href="#eut-search-modal" class="eut-toggle-modal" aria-label="<?php esc_attr_e( 'Search', 'crocal' ); ?>"><span class="eut-item"><i class="eut-icon-search"></i></span></a></li>
						<?php
						} else if ( 'language' == $key ) {
						?>
							<li class="eut-header-element"><a href="#eut-language-modal" class="eut-toggle-modal" aria-label="<?php esc_attr_e( 'Language', 'crocal' ); ?>"><span class="eut-item"><i class="eut-icon-globe"></i></span></a></li>
						<?php
						} else if ( 'login' == $key ) {
						} else if ( 'form' == $key ) {
						?>
							<li class="eut-header-element"><a href="#eut-menu-form-modal" class="eut-toggle-modal" aria-label="<?php esc_attr_e( 'Contact Form', 'crocal' ); ?>"><span class="eut-item"><i class="eut-icon-envelope"></i></span></a></li>
						<?php
						...
						?>
							<li class="eut-header-element">
								...
								<a href="<?php echo esc_url( $get_cart_url ); ?>" aria-label="<?php esc_attr_e( 'Cart', 'crocal' ); ?>">
								<?php } else { ?>
								<a href="#eut-cart-area" class="eut-toggle-hiddenarea" aria-label="<?php esc_attr_e( 'Cart', 'crocal' ); ?>">
								<?php } ?>
									<span class="eut-item">
						...
						?>
							<li class="eut-header-element"><a href="#eut-socials-modal" class="eut-toggle-modal" aria-label="<?php esc_attr_e( 'Social Links', 'crocal' ); ?>"><span class="eut-item"><i class="eut-icon-socials"></i></span></a></li>
						<?php
							} else {
								...
								if ( !empty( $header_social_options ) && !empty( $social_options ) ) {
									...
									foreach ( $social_options as $key => $value ) {
										if ( isset( $header_social_options[$key] ) && 1 == $header_social_options[$key] && $value ) {
											if ( 'skype' == $key ) {
												echo '<li class="eut-header-element"><a href="' . esc_url( $value, array( 'skype', 'http', 'https' ) ) . '" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"><span class="eut-item"><i class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '"></i></span></a></li>';
											} else {
												$link_target = crocal_eutf_option('social_options_link_target', '_blank');
												if ( '_blank' == $link_target ) {
													echo '<li class="eut-header-element"><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"><span class="eut-item"><i class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '"></i></span></a></li>';
												} else {
													echo '<li class="eut-header-element"><a href="' . esc_url( $value ) . '" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"><span class="eut-item"><i class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '"></i></span></a></li>';
												}
											}
										}
									}
...
<?php
									...
									foreach ( $social_options as $key => $value ) {
										if ( isset( $header_social_options[$key] ) && 1 == $header_social_options[$key] && $value ) {
											if ( 'skype' == $key ) {
												echo '<li class="eut-header-responsive-element"><a href="' . esc_url( $value, array( 'skype', 'http', 'https' ) ) . '" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"><span class="eut-item"><i class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '"></i></span></a></li>';
											} else {
												$link_target = crocal_eutf_option('social_options_link_target', '_blank');
												if ( '_blank' == $link_target ) {
													echo '<li class="eut-header-responsive-element"><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"><span class="eut-item"><i class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '"></i></span></a></li>';
												} else {
													echo '<li class="eut-header-responsive-element"><a href="' . esc_url( $value ) . '" aria-label="' . esc_attr( $crocal_eutf_social_list_extended[$key]['title'] ) . '"><span class="eut-item"><i class="' . esc_attr( $crocal_eutf_social_list_extended[$key]['class'] ) . '"></i></span></a></li>';
												}
											}
										}
									}
...
?>
		<a href="#eut-sidearea" class="eut-sidearea-btn eut-toggle-sidearea eut-pullup-icon" aria-label="<?php esc_attr_e( 'Side Area', 'crocal' ); ?>">
...
?>
	<div class="eut-hidden-menu-btn eut-position-right">
		<div class="eut-header-element">
			...
			<a href="#eut-hidden-menu" class="eut-toggle-hiddenarea" aria-label="<?php esc_attr_e( 'Menu', 'crocal' ); ?>">
				<span class="eut-item">
					<span></span>
					<span></span>
					<span></span>
...
?>
	<aside id="eut-sidearea" class="eut-side-area">
		<a class="eut-sidearea-close-btn eut-pullup-icon eut-hide" href="#" aria-label="<?php esc_attr_e( 'Close', 'crocal' ); ?>">
		...
		<div id="eut-cart-area" class="eut-hidden-area">
			<div class="eut-hiddenarea-wrapper">
				...
				<div class="eut-close-btn-wrapper">
					<div class="eut-close-btn"><span class="eut-icon-close" aria-hidden="true"></span><span class="screen-reader-text"><?php esc_html_e( 'Close Cart', 'crocal' ); ?></span></div>
				</div>
				<!-- End Close Button -->
...
?>
	<nav id="eut-hidden-menu" class="eut-hidden-area <?php echo esc_attr( $crocal_eutf_hidden_menu_classes ); ?>" aria-label="<?php esc_attr_e( 'Responsive Main', 'crocal' ); ?>">
		<div class="eut-hiddenarea-wrapper">
			<!-- Close Button -->
			<div class="eut-close-btn-wrapper">
				<div class="eut-close-btn"><span class="eut-icon-close" aria-hidden="true"></span><span class="screen-reader-text"><?php esc_html_e( 'Close Menu', 'crocal' ); ?></span></div>
			</div>
			<!-- End Close Button -->
			<div class="eut-hiddenarea-content">
				<?php
