				...
				<div class="eut-isotope-item eut-hover-item eut-hover-style-none">
					...
					<?php if( empty( $image_link_mode ) ){ ?>
						<figure class="eut-image-hover eut-zoom-none">
							<a class="eut-item-url" data-title="<?php echo esc_attr( $figcaption ); ?>" href="<?php echo esc_url( $image_full_url ); ?>"><span class="screen-reader-text"><?php echo esc_html( $figcaption ); ?></span></a>
