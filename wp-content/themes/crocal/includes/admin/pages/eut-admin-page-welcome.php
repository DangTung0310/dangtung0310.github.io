					...
					<div class="eut-admin-panel-row">
						<div class="eut-admin-panel-column eut-admin-panel-column-1-3">
							<div class="eut-admin-panel-column-content">
								...
								<a href="<?php echo esc_url( $docs_link ); ?>" class="eut-admin-panel-more" target="_blank" rel="noopener noreferrer"><?php esc_html_e( "Read More", 'crocal' ); ?></a>
							</div>
						</div>
						<div class="eut-admin-panel-column eut-admin-panel-column-1-3">
							<div class="eut-admin-panel-column-content">
								...
								<a href="<?php echo esc_url( $videos_link ); ?>" class="eut-admin-panel-more" target="_blank" rel="noopener noreferrer"><?php esc_html_e( "Read More", 'crocal' ); ?></a>
							</div>
						</div>
						<div class="eut-admin-panel-column eut-admin-panel-column-1-3">
							<div class="eut-admin-panel-column-content">
								...
								<a href="<?php echo esc_url( $support_link ); ?>" class="eut-admin-panel-more" target="_blank" rel="noopener noreferrer"><?php esc_html_e( "Read More", 'crocal' ); ?></a>
							</div>
						</div>
					</div>
				</div>
