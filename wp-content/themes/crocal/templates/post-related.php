		...
		<div class="eut-column-wrapper eut-medium-shadow eut-with-shadow">
			<div class="eut-column-content">
				<article id="eut-post-related-<?php the_ID(); ?><?php echo uniqid('-'); ?>">
					<a class="eut-item-url" href="<?php echo esc_url( $crocal_eutf_link ); ?>" target="<?php echo esc_attr( $crocal_eutf_target ); ?>"><span class="screen-reader-text"><?php the_title(); ?></span></a>
